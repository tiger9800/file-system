...
#
TEST = sample1 sample2 createTest createTest2 createTest3 tcreate tcreate2 topen2 read_Dir_test readRootTest badLinkTest unlinkTest writeTest mkdirTest rmdirTest rmdirTest2 seekTest seekTest2 chdirTest statTest tlink tls tunlink2 writeread eraseTest readwrite test1 test2
