...
#
TEST = sample1 sample2 createTest createTest2 createTest3 tcreate tcreate2 topen2 read_Dir_test readRootTest badLinkTest unlinkTest writeTest mkdirTest rmdirTest rmdirTest2
